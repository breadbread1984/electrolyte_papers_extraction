...
from ner import TripletExtractor

FLAGS = flags.FLAGS

def add_options():
  flags.DEFINE_string('input_dir', default = None, help = 'path to directory containing pdfs')
  flags.DEFINE_string('output_dir', default = 'triplet_output', help = 'path to output directory')
  flags.DEFINE_string('ckpt', default = None, help = 'path to checkpoint')
  flags.DEFINE_enum('framework', default = 'huggingface', enum_values = {'huggingface',}, help = 'which framework is used')
